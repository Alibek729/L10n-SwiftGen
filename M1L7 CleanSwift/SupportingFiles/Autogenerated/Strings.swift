...
internal enum L10n {
  internal enum Authorization {
    ...
    internal static let auth = L10n.tr("Localizable", "Authorization.auth", fallback: "Authorization")
    /// Login
    internal static let login = L10n.tr("Localizable", "Authorization.login", fallback: "Login")
    /// Password
