...
final class UIColorHexTest: XCTestCase {
	...
	func test_init_withWrongInt_shouldBeInitFailure() {
		...
		let expectedColor = UIColor(red: 0x98 / 255.0, green: 0x32 / 255.0, blue: 0x15 / 255.0, alpha: 0x77 / 255.0)
	...
	func test_init_withRightInt_shouldBeInitSuccess() {
		let color = 0x987654321577
